...
/***/ "./src/blocks/components/counter/counter.js":
/*!**************************************************!*\
  !*** ./src/blocks/components/counter/counter.js ***!
  \**************************************************/
...
var elButtonMinus = document.querySelector('[data-button-minus]');
var elButtonPlus = document.querySelector('[data-button-plus]');
var inputCounter = document.querySelector('[data-input-counter]');
elButtonMinus.addEventListener('click', function () {
  inputCounter.value--;
...
elButtonPlus.addEventListener('click', function () {
  inputCounter.value++;
});
...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  $('.tabs.product-card__tabs').on('click', '.tabs__title-item', function () {
    var tabs = $('.tabs.product-card__tabs .tabs__title-item'),
        tabContent = $('.tabs.product-card__tabs .tabs__row'); //Удаляем классы  

    tabs.removeClass('tabs__title-item--active');
    tabContent.removeClass('active'); //Добавляем классы 
...
/* WEBPACK VAR INJECTION */(function($) {$('.contacts-slider').slick({
  prevArrow: '<span class="slider-arrow-catalog--left"></span>',
  nextArrow: '<span class="slider-arrow-catalog--right"></span>',
  infinite: true,
  dots: true,
...
/* WEBPACK VAR INJECTION */(function($) {var elColorsInner = document.querySelectorAll('.colors__inner');
elColorsInner.forEach(function (elem) {
  elem.addEventListener('click', function () {
    for (var i = 0; i < elColorsInner.length; i++) {
      elColorsInner[i].classList.remove('colors__inner--active');
    }

    elem.classList.add('colors__inner--active');
  });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_components_counter_counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../blocks/components/counter/counter */ "./src/blocks/components/counter/counter.js");
/* harmony import */ var _blocks_components_counter_counter__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_blocks_components_counter_counter__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _blocks_components_tabs_tabs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_blocks_components_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _modules_s_catalog_items_s_catalog_items__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_s_catalog_items_s_catalog_items__WEBPACK_IMPORTED_MODULE_4__);
